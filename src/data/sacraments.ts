...
export const sacraments: Sacrament[] = [
  {
    ...
    description:
      'A Celebração do Batismo é o primeiro e mais importante sacramento da vida cristã, porta de entrada para todos os demais. Por meio dele a pessoa é libertada do pecado original, renasce pela água e pelo Espírito Santo e passa a fazer parte da Igreja, tornando-se filha de Deus e discípula de Jesus Cristo.\n\nRealizado, em geral, para crianças (mas também disponível a jovens e adultos não batizados), o Batismo é uma celebração comunitária, pois insere o novo cristão na família de fé. Durante o rito, destacam-se sinais importantes como a água (purificação e vida nova), o óleo (força do Espírito Santo), a veste branca (vida nova em Cristo) e a vela (luz de Cristo que deve ser mantida acesa na fé).\n\nAlém de um momento de graça, o Batismo é também um compromisso sério assumido pelos pais e padrinhos, que prometem educar o batizado na fé, ensinando-o a viver os valores do Evangelho e a participar da vida da Igreja.',
    requirements: [
      'Certidão de nascimento da criança',
      'Documentos pessoais dos pais e padrinhos',
      'Comprovante de participação no curso de Batismo (obrigatório para pais e padrinhos)',
      'Em alguns casos, autorização da paróquia de origem (se os padrinhos forem de outra comunidade)',
      'Padrinhos: normalmente 1 padrinho e 1 madrinha; devem ser católicos, batizados, crismados e ter recebido a Eucaristia',
  ...
  },
  {
    ...
    description:
      'A Primeira Eucaristia é o sacramento pelo qual o fiel, devidamente preparado, recebe pela primeira vez o Corpo e o Sangue de Jesus Cristo, presente na Eucaristia. Este sacramento fortalece a vida cristã, une mais profundamente o fiel a Cristo e à Igreja, e o alimenta espiritualmente para viver o Evangelho.\n\nDestina-se, em geral, a crianças a partir dos 9 anos, após um período de formação catequética, podendo também ser recebido por jovens e adultos não iniciados na fé. É um momento marcante de amadurecimento espiritual e de inserção mais plena na vida sacramental da Igreja.\n\nMais do que um rito de passagem, a Primeira Eucaristia é o início de uma vida alimentada pela presença real de Cristo. A Igreja convida as famílias a continuarem acompanhando os filhos na fé, incentivando a participação na Missa e na vida comunitária.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'A Crisma (ou Confirmação) é o sacramento que completa a iniciação cristã, juntamente com o Batismo e a Eucaristia. Por meio dela o fiel recebe a plenitude do Espírito Santo, sendo fortalecido na fé e assumindo, de forma mais consciente e madura, o compromisso de viver e testemunhar o Evangelho.\n\nMais do que um rito, a Crisma é um envio: o cristão é chamado a ser testemunha de Cristo no mundo, defendendo a fé por palavras e atitudes e participando ativamente da missão da Igreja.\n\nDestina-se a jovens e adultos já batizados, normalmente a partir dos 14 ou 15 anos. A Crisma não é o \'fim\' da catequese, mas o início de uma fé adulta e comprometida.',
    requirements: [
  ...
  },
  {
    ...
    requirements: [
      ...
      'Livre consentimento dos noivos',
      'Certidão de nascimento (cópia)',
      'Certidão de Batismo atualizada (emitida há no máximo 6 meses)',
      'Comprovante do casamento civil',
      'Comprovante de residência',
      'Certificado do curso de noivos (obrigatório)',
      ...
      'Reserva da igreja com antecedência (pode ser feita com até 1 ano de antecedência)',
      'Casamento civil obrigatório antes ou no mesmo dia',
      'Casamento fora da igreja ou com noivo de outra religião: necessita autorização especial',
      'Padrinhos: geralmente 2 casais; devem ser exemplo de vida cristã',
    ],
