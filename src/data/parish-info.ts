...
export const history = {
  ...
  milestones: [
    { year: '1973', event: 'Início da Comunidade Nossa Senhora Aparecida.' },
    { year: '1980', event: 'Início da Comunidade Esperança em Cristo.' },
    { year: '1982', event: 'Início da Comunidade Santo Antônio no mês de agosto.' },
    { year: '1990', event: 'Fundação da Comunidade Jesus de Nazaré em 20 de dezembro.' },
    { year: '1991', event: 'A Comunidade Nossa Senhora Aparecida é elevada à condição de Paróquia em 1º de janeiro.' },
    { year: '1992', event: 'Início da Comunidade Atos dos Apóstolos.' },
    { year: '1998', event: 'Fundação da Comunidade Divina Providência em 04 de outubro.' },
    ...
    { year: '2011', event: 'Fundação da Comunidade São João XXIII em 1º de março.' },
    ...
    { year: '2024', event: 'Implantação oficial do Caixa Único Paroquial, em janeiro. Posse do Pe. Nivaldo de Souza Aranda como vigário paroquial, em fevereiro. Celebração do Jubileu de Prata — 25 anos da Paróquia, no mês de outubro. Oficialização da Comunidade São José em 09 de dezembro.' },
    { year: '2025', event: 'Entronização da imagem fac-símile de Nossa Senhora Aparecida, presidida pelo Cardeal Emérito Dom Raymundo Damasceno, em 12 de fevereiro. Oficialização da Comunidade Nossa Senhora da Esperança em 23 de abril.' },
  ],
