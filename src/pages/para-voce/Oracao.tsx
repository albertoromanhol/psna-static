...
const fields = [
  ...
  { name: 'community', label: 'Comunidade', type: 'select' as const, required: false,
    options: [
      { value: 'atos-dos-apostolos',          label: 'Comunidade Atos dos Apóstolos' },
      { value: 'divina-providencia',           label: 'Comunidade Divina Providência' },
      { value: 'nossa-senhora-aparecida',      label: 'Comunidade Nossa Senhora Aparecida' },
      { value: 'nossa-senhora-da-esperanca',   label: 'Comunidade Nossa Senhora da Esperança' },
      { value: 'santo-antonio',                label: 'Comunidade Santo Antônio' },
      { value: 'sao-joao-xxiii',               label: 'Comunidade São João XXIII' },
      { value: 'sao-jose',                     label: 'Comunidade São José' },
    ],
  },
