...
const items = [
  { to: '/para-voce/sacramentos/batismo',             icon: Droplets, title: 'Batismo',             description: 'O primeiro sacramento da fé cristã.' },
  { to: '/para-voce/sacramentos/primeira-eucaristia', icon: Flame,   title: 'Primeira Eucaristia', description: 'O Pão da Vida.' },
  { to: '/para-voce/sacramentos/crisma',              icon: Heart,   title: 'Crisma',              description: 'O dom do Espírito Santo.' },
  { to: '/para-voce/sacramentos/matrimonio',          icon: Church,  title: 'Matrimônio',          description: 'O sacramento do amor conjugal.' },
